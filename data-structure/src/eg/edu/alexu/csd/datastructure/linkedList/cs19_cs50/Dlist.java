...
public class Dlist {
	...
	@Test
	public void test() {
		MyDLinkedList instance = new MyDLinkedList();
		int x0 = 0;
		int x1 = 1;
		int x2 = 2;
		instance.add('a');
	...
	public void test3() {
		...
		object.remove(x4);
		object.set(x7, x8);
		MyDLinkedList object2 = new MyDLinkedList();
		object2 = (MyDLinkedList) object.sublist(x4, x5);
	...
	@Test
	public void test4() {
		MyDLinkedList object = new MyDLinkedList();
		final int j = 6;
		for (int i = 0; i < j; i++) {
			object.add(i, i);
		}
		...
		object.set(x4, x2);
		MyDLinkedList object2 = new MyDLinkedList();
		object2 = (MyDLinkedList) object.sublist(x1, x3);
	...
	@Test
	public void test5() {
		MyDLinkedList c = new MyDLinkedList();
		final int j = 3;
		for (int i = 0; i < j; i++) {
			c.add(i);
		}
		...
		c.set(x1, x7);
		c.set(x4, x8);
		MyDLinkedList d = new MyDLinkedList();
		d.add(x3);
		d.add(x7);
		d.add(x1);
		d.add(x2);
